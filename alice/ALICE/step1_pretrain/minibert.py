...
class BERT(nn.Module):
    ...
    def __init__(self, param):
        ...
        super().__init__()
        self.hidden = param["hidden size"]
        self.n_layers = param["n layers"]
        self.attn_heads = param["attn heads"]
...
class MaskedRoberta(nn.Module):
    ...
    def __init__(self, bert: BERT, param):
        ...
        """
        super().__init__()
        hidden, vocab_size = param['hidden size'], param['vocab']
        self.bert = bert
...
class BERTLM(nn.Module):
    ...
    def __init__(self, bert: BERT, param):
        ...
        super().__init__()
        self.bert = bert
        self.next_sentence = NextSentencePrediction(param)
        self.mask_lm = MaskedLanguageModel(param)
