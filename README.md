...
- **`./alice/`**  
  ...
  Detailed instructions for installation, usage, and training can be found in the dedicated [README](./alice/README.md).

- **`./alice_x/`**  
  Contains the codebase for the **ALICE-X** architecture, including instructions for usage and experiments.
...
This repository serves as a complete framework for **mapping AAV capsid sequences to functional outcomes** through function-guided *in silico* evolution.  
